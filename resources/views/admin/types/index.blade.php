...
<div class="top_content d-flex">
    <h1 class="py-3">Project Types</h1>
</div>
...
<div class="container pt-4">
    <div class="row">
        <div class="col-md-5">
            <h3 class="pb-4">Create New Type</h3>
                        ...
                        <tr class="table-dark">
                            ...
                            <td>
                                <form action="{{route('admin.types.update', $type->slug)}}" method="post">
                                    @csrf
                                    @method('PATCH')
                                    <input type="text" name="name" id="name" class="form-control bg-transparent text-white" value="{{$type->name}}">
